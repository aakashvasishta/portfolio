    ...
    <div className="space-y-14 mt-6">
      ...
      <section>
        ...
        <ChartFrame
          ...
          method="Attrition rate = employees who left divided by total headcount per department over the observation period. Vermilion bars exceed the company average; green bars are below it."
          takeaway="Customer Service and Sales attrition is 2-3x higher than Engineering and Finance. A targeted retention programme for these two departments would cover the majority of avoidable attrition cost."
          height={320}
        >
          <AttritionByDept />
        </ChartFrame>
      ...
      <section>
        ...
        <ChartFrame
          figNum={3}
          title="Satisfaction x Performance: green stayed, vermilion left"
      ...
      <section>
        ...
        <ChartFrame
          ...
          method="Employees grouped into 5 tenure brackets. Attrition rate = departed divided by headcount within each bracket. Bars highlight brackets above 80% of the peak rate."
      ...
      <section>
        <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100 mb-1">
          Department and Compensation Band Risk
        </h2>
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6 leading-relaxed">
        ...
        <ChartFrame
          figNum={5}
          title="Attrition Rate Heatmap: Department x Comp Band"

    ...
    <div className="space-y-14 mt-6">
      ...
      <section>
        ...
        <ChartFrame
          ...
          takeaway="D1 (top 10%) holds 77% of revenue. Add D2 and you reach 84%, meaning the entire bottom 80% of customers contributes just 16%. Retention strategy should be almost entirely focused on the top decile."
          height={320}
        >
          <ParetoChart />
        </ChartFrame>
      ...
      <section>
        ...
        <ChartFrame
          ...
          takeaway="Baseline revenue grew ~40% year-over-year. Q4 spikes reach 1.5-2x the off-peak baseline, confirming that capacity planning (inventory, support, fulfilment) should scale up from early October each year."
          height={320}
        >
          <RevenueTimeline />
        </ChartFrame>
      ...
      <section>
        ...
        <ChartFrame
          ...
          method="Each point is one A/B test variant. X axis = log2(conversion rate / baseline). Y axis = -log10(p-value). Dashed lines mark significance threshold (p < 0.05) and minimum effect size (log2FC > 0.5). Colour = marketing channel."
      ...
      <ChartGlossary rows={[
        {
          ...
          note: 'Bar + line composition that reveals 80/20 concentration in ranked categorical data. The line inflection point marks where marginal revenue contribution collapses.',
        },
        {
          fig: 2,
        ...
        },
        {
          ...
          y: 'product category then subcategory: nested nominal hierarchy',
        ...
        },
        {
          ...
          x: 'log2(fold change vs baseline): continuous, signed effect size',
          y: '-log10(p-value): continuous statistical confidence',
